            ...
            <div className="">
              <div className="lg:w-[570px]">
                ...
                <p className="text__para">
                  ...
                  Debitis tenetur modi odio quisquam? Blanditiis est ducimus
                  neque sed? Quasi consequuntur laudantium dolorum nobis neque
                  vel aspernatur illo tempora unde. Quisquam?
                </p>
              ...
              <div className="mt-[30px] lg:mt-[70px] flex flex-col lg:flex-row lg:items-center gap-5 lg:gap-[30px]">
                <div>
                  <h2 className="text-[36px] leading-[56px] lg:text-[54px] lg:leading-[54px] font-[700] text-headingColor">
                    30+
                  </h2>
